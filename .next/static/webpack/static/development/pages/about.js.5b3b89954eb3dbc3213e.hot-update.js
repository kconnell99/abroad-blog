...
var Post = function Post(data) {
  ...
  return data && react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_NavBar_NavBar__WEBPACK_IMPORTED_MODULE_1__["default"], null), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(PostHeader, {
    style: {
      backgroundImage: URL(postMainImage.fields.file.url)
    }
...
var PostDateContainer = _emotion_styled__WEBPACK_IMPORTED_MODULE_3__["default"].h3(_templateObject2()); // const PostHeader = styled.div<BackgroundImage>(({ photo = '' }) =>{
//     var photostr = String(photo);
//     console.log(photostr.substring(2))
//     return(
//         `
//         background: url(${photostr});
//         `
//     )
// })
// `
...
//# sourceMappingURL=about.js.5b3b89954eb3dbc3213e.hot-update.js.map