...
var Post = function Post(data) {
  ...
  return data && react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_NavBar_NavBar__WEBPACK_IMPORTED_MODULE_1__["default"], null), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(PostHeader, {
    background: postMainImage.fields.file.url
...
var PostDateContainer = _emotion_styled__WEBPACK_IMPORTED_MODULE_3__["default"].h3(_templateObject2()); // const PostHeader=styled.div<PostHeaderProps>(({background = "true"}))=>`
//     position: relative;
//     text-align: center;
// `

var PostHeader = _emotion_styled__WEBPACK_IMPORTED_MODULE_3__["default"].div(function (_ref) {
  var _ref$background = _ref.background,
      background = _ref$background === void 0 ? 'core' : _ref$background;
  return "\n    position: relative;\n    text-align: center;\n    background: url(".concat(background, ");\n");
});
var PostHeaderImage = _emotion_styled__WEBPACK_IMPORTED_MODULE_3__["default"].img(_templateObject3());
var PostBodyContainer = _emotion_styled__WEBPACK_IMPORTED_MODULE_3__["default"].p(_templateObject4());
...
//# sourceMappingURL=post.js.cf951c223f630e8576d5.hot-update.js.map